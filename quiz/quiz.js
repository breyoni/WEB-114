...
if (score >= 3 && score <= totalQuestions) {
    alert("Wow! You're officially an expert on me!");
}
if (score === 0 || score === 1) {
    alert("No worries! You'll get to know me better next time.");
}
    
    // Final summary alert
    alert("Quiz Complete! Final score: " + score + "/" + totalQuestions + "(" + percentage + "%)");
